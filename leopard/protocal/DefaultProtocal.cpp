...
ProtocalHeaderPtr DefaultProtocal::newHeader() {
  return std::make_shared<ProtocalHeader>();
}

void DefaultProtocal::parseHeader(BufferStream* inputStream, ProtocalHeader* header) {
